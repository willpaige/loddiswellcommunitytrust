...
export const pageSchemas: Record<string, PageSchema> = {
  home: {
    ...
    blocks: [
      ...
      { key: "community_residents_number", label: "Parish residents number", type: "inline", group: "Community stats", help: "e.g., 600+" },
      { key: "community_residents_label", label: "Parish residents label", type: "inline", group: "Community stats" },
      { key: "community_clubs_number", label: "Clubs & societies number", type: "inline", group: "Community stats", help: "e.g., 10+" },
